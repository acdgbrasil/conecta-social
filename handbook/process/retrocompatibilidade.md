...
| `@conecta/social-care` (agregado `Patient` + VOs) | Ativo (beta) | v0.1.0 | - | Consolidar eventos e ACLs até v0.3.0; promover a `1.0.0` após contratos externos documentados. | N/A |
