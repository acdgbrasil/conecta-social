...
- Estrutura atual: `src/shared/tests/{unit,regression}` para o shared kernel e `src/modules/social-care/domain/tests/{unit,regression}` para o core domain.
...
- Use `bun test src/shared/tests` ou `bun test src/modules/social-care/domain/tests` para rodadas completas; `--filter "<pacote|arquivo>"` agiliza ciclos menores.
