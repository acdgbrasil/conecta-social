...
} from "@conecta/social-care/application/use-cases/register-patient.use-case";
import { PatientRepositoryProtocol } from "@conecta/social-care/application/protocols/patient.repository.protocol";
import { inMemoryEventBus } from "@conecta/adapters";
import { Patient, PersonId, FamilyMember } from "@conecta/social-care";
import { PatientSQLiteRepository } from "@conecta/social-care/infrastructure/database/memory/SQLite/patient.sqlite.repository";
