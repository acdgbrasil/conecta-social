...
import { Diagnosis, ICDCode, Patient, PersonId, Timestamp } from "@conecta/social-care";
...
import { createDtoIcdCode, createDtoPersonID } from "@conecta/social-care/application/dto/patient.dto";
