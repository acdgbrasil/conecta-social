// __tests__/Patient.entity.test.ts
...
import { None } from "src"; // Ajuste o import se 'src' não for o alias correto
import { P } from "../../err/Patient.error"; // Importando os erros do Paciente
